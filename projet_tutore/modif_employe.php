						...
						<div class="container">
							...
							<form method="post" action="">
								<div class="row">
									...
									Compétence 1 : <div class="6u 12u$(mobile)"><input type="text" name="cmp1" /></div>								
									</br></br></br>
									Compétence 2 : <div class="6u 12u$(mobile)"><input type="text" name="cmp2" /></div>								
									</br></br></br>
									Compétence 3 : <div class="6u 12u$(mobile)"><input type="text" name="cmp3" /></div>								
									</br></br></br>
